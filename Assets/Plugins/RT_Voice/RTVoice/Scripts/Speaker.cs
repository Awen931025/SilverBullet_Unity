...
//using static Crosstales.RTVoice.Provider.BaseVoiceProvider;
...
namespace Crosstales.RTVoice
{
    ...
    public class Speaker : MonoBehaviour
    {
        ...
        /// 0：停止播放  >0正在播放，一般都是1
        /// </summary>
        public static int speakCounter = 0;
...
*/
        ...
        public  Speaker WSpeak(string text, AudioSource source = null, Model.Voice voice = null, bool speakImmediately = true, float rate = 1f, float pitch = 1f, float volume = 1f, string outputFile = "")
        {
    ...
    public static class SpeakerExterntion
    {
        //public static void OnComplete(this Speaker tts, SpeakComplete eventHandle)
        //{
        //    Speaker.OnSpeakComplete += eventHandle;
        //}

        public static void OnComplete(this Speaker tts, Action eventHandle)
        {
