...
namespace W
{
    public class U_Texture
    {
        ...
        /// <returns></returns>
        public static List<Texture2D> GifToTextureByCS(Image image)
        {
        ...
        /// <returns></returns>
        public static List<Texture2D> GifToTextureByCS(string name)
        {
            string path = string.Format("{0}/StreamingAssets/", Application.dataPath);
            return GifToTextureByCS(Image.FromFile(path + "/" + name + ".gif"));
