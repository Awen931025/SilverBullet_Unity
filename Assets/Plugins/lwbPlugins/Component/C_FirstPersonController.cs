...
#pragma warning disable 0649
        ...
        #region 下蹲
        public bool isEnableXiadun = false;
        public float xiadunGaodu = 0.4f;
        bool isXiadunIng=false;
        float  oriGaodu;
        void XiadunSwitch()
        {
            if(isXiadunIng)
            {
                isXiadunIng = false;
                m_Camera.transform.localPosition = new Vector3(m_Camera.transform.localPosition.x, oriGaodu, m_Camera.transform.localPosition.z);
            }
            else
            {
                isXiadunIng = true;
                oriGaodu = m_Camera.transform.localPosition.y;
                m_Camera.transform.localPosition = new Vector3(m_Camera.transform.localPosition.x, xiadunGaodu, m_Camera.transform.localPosition.z);
        ...
        {
            if (isUseMousePress&& !Input.GetMouseButton(0))
                return;
