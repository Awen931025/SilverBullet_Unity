...
namespace Cogobyte.ProceduralIndicators
{
    ...
    public class ArrowPath : ScriptableObject
    {
        ...
        void OnValidate()
        {
            ...
            widthFunctionLength = Mathf.Max(widthFunctionLength, 0.1f);
            heightFunctionLength = Mathf.Max(heightFunctionLength, 0.1f);
            rotationFunctionLength = Mathf.Max(rotationFunctionLength, 0.1f);
            shapeFunctionLength = Mathf.Max(shapeFunctionLength, 0.1f);
